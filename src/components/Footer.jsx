...
//         .ft { background: #111; color: #fff; font-family: 'Syne', sans-serif; border-radius: 16px; overflow: hidden; }
...
//         .ft-divider { background: #2a2a2a; }

//         .ft-col { padding: 0 24px; }
//         .ft-col:first-child { padding-left: 0; }
//         .ft-col:last-child  { padding-right: 0; }

//         .ft-label { font-size: 14px; font-weight: 700; color: #fff; margin-bottom: 18px; }

//         .ft-email-row { display: flex; align-items: center; margin-bottom: 16px; }
//         .ft-input {
//           background: #222; border: none; outline: none;
//           color: #fff; font-family: 'Syne', sans-serif; font-size: 13px;
//           padding: 10px 14px; border-radius: 100px 0 0 100px; flex: 1; min-width: 0;
//         }
//         .ft-input::placeholder { color: #555; }
//         .ft-btn {
//           background: #2be38a; border: none; cursor: pointer;
//           width: 38px; height: 38px; border-radius: 50%;
//           display: flex; align-items: center; justify-content: center;
//           flex-shrink: 0; transition: background 0.2s;
//         }
//         .ft-btn:hover { background: #22c97a; }
...
//         }
//         .ft-social:hover { border-color: #666; }

//         .ft-nav a {
//           display: block; color: #fff; text-decoration: none;
//           font-size: 14px; font-weight: 700; margin-bottom: 14px;
//           opacity: 0.85; transition: opacity 0.2s; letter-spacing: 0.01em;
//         }
//         .ft-nav a:hover { opacity: 1; }

//         .ft-wordmark-wrap {
//           padding: 0 36px; border-top: 1px solid #222;
//           overflow: hidden; line-height: 0.85;
//         }
//         .ft-wordmark {
...
//         }
//         .ft-reg { font-size: 0.28em; vertical-align: super; margin-left: 0.05em; }

//         .ft-bottom {
//           padding: 14px 36px; border-top: 1px solid #222;
//           display: flex; justify-content: space-between;
//           align-items: center; flex-wrap: wrap; gap: 8px;
//         }
//         .ft-legal { display: flex; gap: 12px; flex-wrap: wrap; align-items: center; }
//         .ft-legal span, .ft-legal a { font-size: 11px; color: #555; text-decoration: none; }
//         .ft-legal a:hover { color: #999; }
//         .ft-made { font-size: 11px; color: #555; }
//       `}</style>
...
//               {["Facebook","X","LinkedIn","YouTube","TikTok","Instagram"].map(s => (
//                 <div className="ft-social" key={s} title={s} role="link" tabIndex={0} aria-label={s}>
